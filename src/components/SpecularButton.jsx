...
const SpecularButton = ({
  ...
  useEffect(() => {
    ...
    propsRef.current = {
      radius,
      lineColor: lineColor || (isLight ? '#ca8a04' : '#facc15'),
      baseColor: baseColor || (isLight ? '#fde047' : '#eab308'),
      intensity,
      shineSize,
      shineFade,
      thickness,
  ...
  useEffect(() => {
    ...
    let renderer, gl, mesh, ro, animationFrameId;
